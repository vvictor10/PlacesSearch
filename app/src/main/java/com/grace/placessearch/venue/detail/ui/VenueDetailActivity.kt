...
class VenueDetailActivity : BaseNavigationActivity(), VenuesContract.View {
    ...
    override fun onSearch(venues: MutableList<Venue>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun onSuggestedSearches(suggestedSearches: MutableList<String>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    private fun setupAddressInfo(venue: Venue) {
        if (venue.location != null && !venue.location.formattedAddress.isEmpty()) {
    ...
    private fun loadMapImage(imageView: ImageView, venue: Venue) {
        ...
        val imageUrl = getMapImageUrl(venue) ?: return
