 ...
 */
@Deprecated
public class VenuesMapActivityOrig extends AppCompatActivity implements
        OnMapAndViewReadyListenerOrig.OnGlobalLayoutAndMapReadyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new OnMapAndViewReadyListenerOrig(mapFragment, this);
    }
