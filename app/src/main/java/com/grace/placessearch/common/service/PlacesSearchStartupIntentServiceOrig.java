 ...
 */
@Deprecated
public class PlacesSearchStartupIntentServiceOrig extends IntentService {
    ...
    public PlacesSearchStartupIntentServiceOrig() {
        super(PlacesSearchStartupIntentServiceOrig.class.getName());
    }
