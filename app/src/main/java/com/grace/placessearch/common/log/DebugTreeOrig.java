 ...
 */
@Deprecated
public class DebugTreeOrig extends Timber.DebugTree {
    ...
    protected final String applicationTag;

    public DebugTreeOrig(String tag) {
        applicationTag = tag;
    }
    ...
    protected void throwShade(int priority, String message, Throwable t) {
